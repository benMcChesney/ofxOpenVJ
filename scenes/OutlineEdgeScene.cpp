...
#include "OutlineEdgeScene.h"

//--------------------------------------------------------------
OutlineEdgeScene::OutlineEdgeScene() {
...
//--------------------------------------------------------------
void OutlineEdgeScene::setup() {
    
}

//--------------------------------------------------------------
void OutlineEdgeScene::setupGui(float a_x, float a_y) {
    // creates new gui and adds the name to it //
    BaseScene::setupGui(a_x, a_y);
    
    gui->addSlider( "OUTLINE SMOOTHING", 1, 35 , &outlineSmoothing ) ;

    ofAddListener( gui->newGUIEvent, this, &OutlineEdgeScene::guiEvent );
    loadSettings() ; 
}

//--------------------------------------------------------------
void OutlineEdgeScene::guiEvent(ofxUIEventArgs &e) {
...
bool OutlineEdgeScene::transitionIn( float delay , float transitionTime )
{
...
bool OutlineEdgeScene::transitionOut( float delay , float transitionTime )
{
