...
void FractalTunnelScene::setupGui(float a_x, float a_y)
{
    BaseScene::setupGui( a_x , a_y ) ;

	ofxOpenVJConstants *c = ofxOpenVJConstants::Instance(); 
	gui.add( reloadShader.setup("RELOAD SHADER"));
	reloadShader.addListener(this, &FractalTunnelScene::loadShaders );
	/*
...
void FractalTunnelScene::loadShaders()
{
	shader.load("Shaders/fractalTunnel.vert", "Shaders/fractalTunnel.frag");
}



void FractalTunnelScene::update()
{
...
bool FractalTunnelScene::transitionIn( float delay , float transitionTime )
{
...
bool FractalTunnelScene::transitionOut( float delay , float transitionTime )
{
...
void FractalTunnelScene::drawDebug( )
{
	sceneTransitionTimer.draw(50 , 50);
}

void FractalTunnelScene::activate()
{
    BaseScene::activate() ; 
}

void FractalTunnelScene::deactivate()
{
