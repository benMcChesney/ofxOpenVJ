...
class MRSFractalShaderScene : public BaseScene
{
public :
	MRSFractalShaderScene() {}
	MRSFractalShaderScene( int a_index, string a_name ):BaseScene( a_index, a_name ) {}
...
//    void guiEvent(ofxUIEventArgs &e);
	...
	ofxFloatSlider cellScale; 
	ofxFloatSlider maxCellScale; 
	ofxFloatSlider minCellScale;
